...
function Product({ item }) {
  ...
  return (
    <div className='flex flex-col justify-between items-center gap-3 p-1 py-4 sm:p-4 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:shadow-[0px_0px_95px_53px_#00000024] hover:scale-105 transition-all duration-300 ease-in'>
